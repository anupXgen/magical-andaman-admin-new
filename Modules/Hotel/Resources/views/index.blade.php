      ...
      <div class="card custom-card">
        <div class="card-header d-block">
          <div class="d-sm-flex d-block align-items-center justify-content-between">
            <div class="h5 fw-semibold mb-0">Hotel Management</div>
            <div class="d-flex mt-sm-0 mt-2 align-items-center">
              <form id='searchform' name='searchform' action=''>
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0" placeholder="Search hotel" aria-describedby="search-contact-member" id='search_txt' name='search_txt'>
              ...
              @can('hotel-create')
              <a href="{{ route('hotel.create') }}" class="btn btn-success ms-2">Create</a>
              @endcan
            </div>
          </div>
        </div>
        <div class="card-body">
          <table id="" class="table table-bordered text-nowrap w-100 mb-2">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ ++$i }}</td>
                <td>{{ ucfirst($hotel->title) }}</td>
                <td>{{ ucfirst(substr($hotel->subtitle,0, 100).'..') }}</td>
                <td>
