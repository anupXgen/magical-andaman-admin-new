        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ul class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('hotel_category.index') }}">Blogs</a></li>
            ...
            <div class="card custom-card">
                <div class="card-header d-block">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-semibold mb-0">Hotel Category Create</div>
                ...
                <div class="card-body">
                    <div class="col-xl-12">
                        ...
                        @endif
                        <form class="row g-3 mt-0" method="POST" action="{{ route('hotel_category.store') }}" id="creation_form" name="creation_form">
                            @csrf
                            <div class="col-md-6">
                                <label class="form-label">Category Title</label>
                                <input type="text" class="form-control" placeholder="Category Title" aria-label="Title" id="category_title" name="category_title">
                            </div>
