      ...
      <div class="card custom-card">
        <div class="card-header d-block">
          <div class="d-sm-flex d-block align-items-center justify-content-between">
            <div class="h5 fw-semibold mb-0">PNR Management</div>
            <div class="d-flex mt-sm-0 mt-2 align-items-center">
              <form id='searchform' name='searchform' action=''>
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0" placeholder="Search PNR" aria-describedby="search-contact-member" id='search_txt' name='search_txt'>
              ...
              @can('hotel-create')
              <a href="{{ route('pnrstatus.create') }}" class="btn btn-success ms-2">Create</a>
              @endcan
            </div>
          </div>
        </div>
          ...
          <table id="" class="table table-bordered text-nowrap w-100 mb-2">
            ...
            <tbody>
              ...
              <tr>
                ...
                {{-- <td>
                  <a class="btn btn-info" href="{{ route('pnrstatus.show',$pnr->id) }}">Show</a>
                  @can('hotel-edit')
                  <a class="btn btn-primary" href="{{ route('pnrstatus.edit',$pnr->id) }}">Edit</a>
                  @endcan
                  @can('hotel-delete')
                  {!! Form::open(['method' => 'DELETE','route' => ['pnrstatus.destroy', $pnr->id],'style'=>'display:inline']) !!}
