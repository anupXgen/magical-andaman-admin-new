      ...
      <div class="card custom-card">
        <div class="card-header d-block">
          <div class="d-sm-flex d-block align-items-center justify-content-between">
            <div class="h5 fw-semibold mb-0">Destination Management</div>
            <div class="d-flex mt-sm-0 mt-2 align-items-center">
              <form id='searchform' name='searchform' action=''>
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0" placeholder="Search destination" aria-describedby="search-contact-member" id='search_txt' name='search_txt'>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {!! Form::open(['method' => 'DELETE','route' => ['destination.destroy', $destination->id],'style'=>'display:inline']) !!}
