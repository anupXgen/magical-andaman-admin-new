            ...
            <div class="card custom-card">
                <div class="card-header d-block">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-semibold mb-0">User Create</div>
                ...
                <div class="card-body">
                    <div class="col-xl-12">
                        ...
                        @endif
                        <form class="row g-3 mt-0" method="POST" action="{{ route('user.store') }}" id="creation_form" name="creation_form">
                            @csrf
                            <div class="col-md-6">
    ...
    $(document).on('submit', "#creation_form", function(e) {
        ...
        if ($.trim($("#password").val()) == '') {
            ...
            if ($.trim($("#confirm-password").val()) == '') {
                $("#confirm-password").after("<div class='invalid-feedback invalid_msg' id='invalid_msg_confirm-password'>Please confirm password.</div>");
