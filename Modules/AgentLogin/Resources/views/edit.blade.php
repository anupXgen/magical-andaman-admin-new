                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="col-xl-12">
                            ...
                            <form class="row g-3 mt-0" method="POST" action="{{ route('agentlogin.update',$agent->id) }}"
                                id="creation_form">
                                @csrf
                                @method('PATCH')
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone" id="phone"
                                        name="phone" value="{{ old('phone',$agent->phone) }}">
                                    <span class="text-danger">
                                        @error('phone')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Address" id="address"
                                        name="address" value="{{ old('address',$agent->address) }}">
                                    <span class="text-danger">
                                        @error('address')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" class="form-control" placeholder="password_confirmation "
                                        ...
                                        value="{{ old('password_confirmation',$agent->password_confirmation) }}">         
