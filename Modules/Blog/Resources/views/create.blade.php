            ...
            <div class="card custom-card">
                <div class="card-header d-block">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-semibold mb-0">Blog Create</div>
                    ...
                    <div class="col-xl-12">
                        ...
                        <form class="row g-3 mt-0" method="POST" action="{{ route('blog.store') }}" id="creation_form" name="creation_form">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Author" aria-label="Author" id="author" name="author">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Subtitle</label>
                                <textarea class="form-control ckeditor" placeholder="Subtitle" aria-label="Subtitle" id="subtitle" name="subtitle" rows='4' cols='50'> </textarea>
                            </div>
                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    Dropzone.options.documentDropzone = {
        ...
        success: function(file, response) {
            ...
            if (response.name != '') {
                $('form').append('<input type="hidden" name="blog_img[]" value="' + response.name + '">')
        ...
        removedfile: function(file) {
            ...
            $('form').find('input[name="blog_img[]"][value="' + name + '"]').remove();
