            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="col-xl-12">
                        ...
                        @endif
                        <form class="row g-3 mt-0" method="POST" action="{{ route('partners.store') }}" id="creation_form" name="creation_form">
                            @csrf
                            <div class="col-md-6">
                                <label class="form-label">Comapny Name</label>
                                <input type="text" class="form-control" placeholder="Company Name" aria-label="title" id="title" name="company_name">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Company Address</label>
                                <textarea class="form-control" placeholder="Company Address" aria-label="address" id="address" name="address" rows='4' cols='50'> </textarea>
                            </div>
                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    Dropzone.options.documentDropzone = {
        ...
        removedfile: function(file) {
            ...
            $('form').append('<input type="hidden" name="remove_partner_img[]" value="' + name + '">')
        },
        init: function() {
