            ...
            <div class="d-flex mt-sm-0 mt-2 align-items-center">
              <form id='searchform' name='searchform' action=''>
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0" placeholder="Search Question/Answer" aria-describedby="search-contact-member" id='search_txt' name='search_txt'>
              ...
              @can('activity-create')
              <a href="{{ route('faq.create') }}" class="btn btn-success ms-2">Create</a>
              @endcan
            </div>
          </div>
        </div>
        <div class="card-body">
          <table id="" class="table table-bordered text-nowrap w-100 mb-2">
            ...
            <tbody>
              ...
              <tr>
                <td style="inline-size: 300px; white-space: normal; ">{{ ucfirst($faq->questions) }}</td>
                <td style="inline-size: 400px; white-space: normal; ">{{ ucfirst($faq->answers) }}</td>
                <td style="inline-size: 400px; white-space: normal; ">{{ ucfirst($faq->faq_cat->category_title) }}</td>
