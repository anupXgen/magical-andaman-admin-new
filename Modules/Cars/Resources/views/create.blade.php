            ...
            <div class="card custom-card">
                <div class="card-header d-block">
                    <div class="d-sm-flex d-block align-items-center justify-content-between">
                        <div class="h5 fw-semibold mb-0">Car Create</div>
                ...
                <div class="card-body">
                    <div class="col-xl-12">
                        ...
                        @endif
                        <form class="row g-3 mt-0" method="POST" action="{{ route('cars.store') }}" id="creation_form" name="creation_form">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="car_category" id="car_category">
                                    ...
                                    @foreach($car_categories as $category)
                                        <option value="{{ $category->id }}" {{ ($category->id == $category->car_category) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Seater" aria-label="Subtitle" id="seater" name="seater" rows='4' cols='50'> 
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" placeholder="Price" aria-label="Price Per Hour" id="price" name="price_per_hour" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1').replace(/(\.\d\d)\d/g, '$1');">
                            </div>
                            <div class="col-md-10">
                                <label class="form-label" for="document">Car Images </label><span class="text-muted"> Only JPEG and JPG and PNG file types are allowed</span>
...
<script type="text/javascript">
    ...
    Dropzone.options.documentDropzone = {
        ...
        success: function(file, response) {
            ...
            if (response.name != '') {
                $('form').append('<input type="hidden" name="car_images[]" value="' + response.name + '">')
        ...
        removedfile: function(file) {
            ...
            $('form').find('input[name="car_images[]"][value="' + name + '"]').remove();
    ...
    $(document).on('submit', "#creation_form", function(e) {
        ...
        var activity_img = {};
        if ($("input[name='car_images[]']").length == 0) {
